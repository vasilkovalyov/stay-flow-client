...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        'px-[10px] py-[8px] text-xs text-muted-foreground data-inset:pl-[33.25px]',
        className,
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        `
          flex cursor-default items-center gap-[7px]
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      className={cn(
        `
          relative flex cursor-default items-center gap-[8px]

          radius-lg py-[7px] pr-[28px] pl-[10px]
          font-semibold
          outline-hidden select-none
    ...
    >
      <span
        className="pointer-events-none absolute right-[7px] flex items-center justify-center"
