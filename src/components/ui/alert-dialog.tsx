  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        className={cn(
          `
            group/alert-dialog-content fixed top-1/2 left-1/2
            z-50 grid w-full
            -translate-x-1/2 -translate-y-1/2 gap-[21px]

            rounded-xl bg-popover p-[21px]
            text-popover-foreground
            shadow-xl ring-1 ring-foreground/5
            duration-100
            outline-none

            data-[size=default]:max-w-[280px]
            data-[size=sm]:max-w-[280px]
            data-[size=default]:sm:max-w-[392px]
...
function AlertDialogHeader({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        `
          grid grid-rows-[auto_1fr] place-items-center
          gap-[6px] text-center

          has-data-[slot=alert-dialog-media]:grid-rows-[auto_auto_1fr]
          has-data-[slot=alert-dialog-media]:gap-x-[21px]
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        'font-heading text-[18px] font-semibold sm:group-data-[size=default]/alert-dialog-content:group-has-data-[slot=alert-dialog-media]/alert-dialog-content:col-start-2',
        className,
      )}
      {...props}
    />
