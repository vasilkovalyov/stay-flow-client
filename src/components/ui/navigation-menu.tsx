...
const navigationMenuTriggerStyle = cva(
  `
    group/navigation-menu-trigger inline-flex h-[31.5px]
    w-max items-center justify-center

    rounded-xl px-[15.75px] py-[8px]
    font-semibold
    transition-all
    outline-none
...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{' '}
      <ChevronDownIcon
        className="relative top-px ml-[4px] size-[10px] transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group-data-open/navigation-menu-trigger:rotate-180"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  );
      ...
      >
        <NavigationMenuPrimitive.Popup
          className="
            ...
            xs:w-(--popup-width) origin-(--transform-origin)
    ...
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        `
          ...
          in-data-[slot=navigation-menu-content]:radius-lg
...
function NavigationMenuIndicator({
  ...
  return (
    <NavigationMenuPrimitive.Icon
      ...
      className={cn(
        'top-full z-1 flex h-[6px] items-end justify-center overflow-hidden data-[state=hidden]:animate-out data-[state=hidden]:fade-out data-[state=visible]:animate-in data-[state=visible]:fade-in',
        className,
      )}
      {...props}
    >
      <div className="relative top-[60%] h-[7px] w-[7px] rotate-45 rounded-tl-[4px] bg-border shadow-md" />
    </NavigationMenuPrimitive.Icon>
  );
}
