      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          `
            ...
            max-w-[calc(100%-2rem)] sm:max-w-[392px]
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-[14px] right-[14px] bg-secondary"
                size="sm"
              />
            }
          >
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn('flex flex-col-reverse gap-[7px] sm:flex-row sm:justify-end', className)}
      {...props}
    >
      {children}
      {showCloseButton && (
